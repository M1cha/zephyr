 ...
 * @param[in]  name_len The size of the buffer behind \p name. Must be >= 48.
 *
 * @retval 0        On success
 ...
 * @param[in]  serial_len The size of the buffer behind \p serial. Must be >= 48.
 *
 * @retval 0        On success
 ...
 * @retval -errno   For other failures.
 */
int sen6x_set_voc_algorithm_state(const struct device *dev, const struct sen6x_voc_algorithm_state *state);
